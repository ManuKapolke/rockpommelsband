    ...
    return (
        <div className={styles.privacy}>
            ...
            <section>
                ...
                <h4>Speicherdauer</h4>
                <p>Daten werden in Server-Log-Dateien in einer Form, die die Identifizierung der betroffenen Personen ermöglicht, maximal für [Bitte Informationen ergänzen] gespeichert; es sei denn, dass ein sicherheitsrelevantes Ereignis auftritt (z.B. ein DDoS-Angriff).</p>
            ...
            <section>
                ...
                <p><a href="mailto:mail@manukapolke.de">mail@manukapolke.de</a></p>
            </section>
    ...
    return (
        <div className={styles.privacy}>
            ...
            <section>
                ...
                <p>Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten k&ouml;nnen Sie dem Abschnitt <a href="#responsible-person">&bdquo;Hinweis zur Verantwortlichen Stelle&ldquo;</a> in dieser Datenschutzerkl&auml;rung entnehmen.</p>
            ...
            <section>
                ...
                <p>Telefon: <a href="tel:+4917682065119">+49 (0) 176 82065119</a><br />
                    E-Mail: <a href='mailto:mail@manukapolke.de'>mail@manukapolke.de</a></p>
            ...
            <section>
                ...
                <p className={styles.sourceInfo}>Quelle: <a href="https://www.e-recht24.de">https://www.e-recht24.de</a></p></section>
        </div>
    );
};