    ...
    <div className={styles.privacy}>
      ...
      <section>
        ...
        <p>
          ...
          91052 Erlangen
          <br />
          <a href="mailto:mail@manukapolke.de">mail@manukapolke.de</a>
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          Funktionalität unserer Website sowie der Sicherstellung der
        ...
        <p>
          ...
          Identifizierung der betroffenen Personen ermöglicht, maximal für
          [Bitte Informationen ergänzen] gespeichert; es sei denn, dass ein
          sicherheitsrelevantes Ereignis auftritt (z.B. ein DDoS-Angriff).
        </p>
        <p>
          Im Falle eines solchen Ereignisses werden Server-Log-Dateien bis zur
          Beseitigung und vollständigen Aufklärung des sicherheitsrelevanten
        ...
        <p>
          Sie können Sie über die bereitgestellten Telefonnummern Kontakt zu uns
          aufnehmen. Hierbei erheben wir Protokolldaten, die Ihre Telefonnummer
          und die Dauer des Gesprächs beinhalten.
        </p>
        <p>
  ...
  return (
    <div className={styles.privacy}>
      ...
      <section>
        ...
        <h3 id="responsible-person">Hinweis zur verantwortlichen Stelle</h3>
        <p>
      ...
      <section>
        ...
        <p>
          ...
          Seiten ist die Google Ireland Limited, Gordon House, Barrow Street,
          Dublin 4, Irland.
        </p>

        <p>
          Wir nutzen YouTube im erweiterten Datenschutzmodus. Laut YouTube
          werden in diesem Modus keine Cookies auf Ihrem Endgerät gespeichert,
          bevor Sie das Video abspielen. Allerdings werden auch im erweiterten
          Datenschutzmodus beim Aufrufen der Seite personenbezogene Daten (z.B.
          IP-Adresse) an YouTube übermittelt. Auf diese Datenübertragung haben
          wir keinen Einfluss.
        </p>

        <p>
          Erst wenn Sie ein eingebettetes YouTube-Video aktiv durch Klick laden,
          wird eine Verbindung zu den Servern von YouTube hergestellt. Dabei
          wird YouTube mitgeteilt, welche unserer Seiten Sie besucht haben. Wenn
          Sie in Ihrem YouTube-Account eingeloggt sind, kann YouTube Ihr
          Surfverhalten direkt Ihrem persönlichen Profil zuordnen. Dies können
        ...
        <p>
          ...
          entsprechende Einwilligung abgefragt wurde (z.B. durch eine
          2-Klick-Lösung), erfolgt die Verarbeitung ausschließlich auf Grundlage
